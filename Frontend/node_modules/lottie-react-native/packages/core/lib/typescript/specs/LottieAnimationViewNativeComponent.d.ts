...
export declare type OnAnimationFinishEvent = Readonly<{
    isCancelled: boolean;
}>;
declare type ColorFilterStruct = Readonly<{
    keypath: string;
    color: ProcessedColorValue;
}>;
declare type TextFilterIOSStruct = Readonly<{
    keypath: string;
    text: string;
}>;
declare type TextFilterAndroidStruct = Readonly<{
    find: string;
    replace: string;
}>;
...
declare type LottieViewNativeComponentType = NativeComponentType<NativeProps>;
